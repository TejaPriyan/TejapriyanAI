...
import { IconCopy, IconCheck, IconRefresh, IconVolume, IconVolumeOff, IconFolder } from "./Icons";
    ...
    >
      {!isUser && (
        <motion.div
          ...
          className="mt-1 flex h-8 w-8 min-w-[32px] max-w-[32px] min-h-[32px] max-h-[32px] shrink-0 items-center justify-center rounded-full bg-sand-100 p-0.5 shadow-sm ring-1 ring-sand-200 dark:bg-sand-800 dark:ring-sand-700"
        >
          ...
          <img
            ...
            width={28}
            height={28}
            className="h-full w-full object-contain filter drop-shadow-[0_1px_4px_rgba(56,189,248,0.3)]"
          />
        </motion.div>
      )}
